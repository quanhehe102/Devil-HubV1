...
local Tabs = {
    ...
    Setting = Window:AddTab({ Title = "Cài Đặt Fram", Icon = "settings" }),
    ...
    Misc = Window:AddTab({ Title = "Cài Đặt Khác", Icon = "list-plus" }),
...
ImageButton.Image = "rbxassetid://120293165273353"

UICorner.CornerRadius = UDim.new(0, 30)
UICorner.Parent = ImageButton

UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(244, 0, 0)), ColorSequenceKeypoint.new(0.32, Color3.fromRGB(146, 255, 251)), ColorSequenceKeypoint.new(0.65, Color3.fromRGB(180, 255, 255)), ColorSequenceKeypoint.new(1, Color3.fromRGB(96, 255, 231))}
...
local listfastattack = {'Normal Attack','Fast Attack','Super Fast Attack'}
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Tự Động Fram Level", Default = false })
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    ...
    local ToggleMasteryFruit = Tabs.Main:AddToggle("ToggleMasteryFruit", {Title = "Tự Động Thông Thạo Trái", Default = false })
    ToggleMasteryFruit:OnChanged(function(Value)
        AutoFarmMasDevilFruit = Value
    end)
    Options.ToggleMasteryFruit:SetValue(false)

    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Tự Động Thông Thạo Súng", Default = false })
...
if Third_Sea then
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Tự Động Xương", Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Tự Động CakePrince", Default = false })
...
spawn(function()
    ...
    if Second_Sea then
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Tự Động Vật Chất Kì Dị", Default = false })
...
local boss = Tabs.Main:AddSection("Boss Farm")
    ...
    local ToggleMaterial = Tabs.Main:AddToggle("ToggleMaterial", {Title = "Tự Động Nguyên Liệu", Default = false })
...
if Third_Sea then
    ...
    spawn(function()
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = "Đánh Cá Mập", Default = false })
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Tự Động Elite Hunter", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Tự Động Sea Beast", Default = false })
...
local ToggleTweenMirageIsland = Tabs.Main:AddToggle("ToggleTweenMirageIsland", {Title = "Đi Tới Đảo Bí Ẩn", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Ngắm Trăng Và Sử Dụng Tộc V3", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Tự Động Thức Tỉnh Trái Ác Quỷ", Default = false })
